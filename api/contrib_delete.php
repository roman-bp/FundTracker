...
// (опційно) перевіримо що запис існує
$chk = $conn->prepare("SELECT id FROM contributions WHERE id = ? LIMIT 1");
...
$stmt = $conn->prepare("DELETE FROM contributions WHERE id = ? LIMIT 1");
